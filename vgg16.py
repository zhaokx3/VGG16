...
class VGG16:
    def __init__(self, config, weights=None, sess=None):
    ...
    def predict_(self, is_Train):
        images = pre_process()
        out_fc = cnn_fc(images, self.num_classes, is_Train, 'fc')
        return out_fc
    ...
    def cnn_fc(self, input_, num_classes = 1000, is_Train, name):
        trainable = is_Train
        ...
        with tf.variable_scope(name) as scope:
            ...
            conv1_1, kernel1_1, bias1_1  = conv_layer('conv1_1', input_, 64, 3, trainable)
            self.parameters += [kernel1_1, bias1_1]
            
            conv1_2, kernel1_2, bias1_2  = conv_layer('conv1_2', conv1_1, 64, 3, trainable)
            ...
            conv2_1, kernel2_1, bias2_1  = conv_layer('conv2_1', pool1, 128, 3, trainable)
            self.parameters += [kernel2_1, bias2_1]
            
            conv2_2, kernel2_2, bias2_2  = conv_layer('conv2_2', conv2_1, 128, 3, trainable)
            ...
            conv3_1, kernel3_1, bias3_1  = conv_layer('conv3_1', pool2, 256, 3, trainable)
            self.parameters += [kernel3_1, bias3_1]
            
            conv3_2, kernel3_2, bias3_2  = conv_layer('conv3_2', conv3_1, 256, 3, trainable)
            self.parameters += [kernel3_2, bias3_2]
            
            conv3_3, kernel3_3, bias3_3  = conv_layer('conv3_3', conv3_2, 256, 3, trainable)
            ...
            conv4_1, kernel4_1, bias4_1  = conv_layer('conv4_1', pool3, 512, 3, trainable)
            self.parameters += [kernel4_1, bias4_1]
            
            conv4_2, kernel4_2, bias4_2  = conv_layer('conv4_2', conv4_1, 512, 3, trainable)
            self.parameters += [kernel4_2, bias4_2]
            
            conv4_3, kernel4_3, bias4_3  = conv_layer('conv4_3', conv4_2, 512, 3, trainable)
            ...
            conv5_1, kernel5_1, bias5_1  = conv_layer('conv5_1', pool4, 512, 3, trainable)
            self.parameters += [kernel5_1, bias5_1]
            
            conv5_2, kernel5_2, bias5_2  = conv_layer('conv5_2', conv5_1, 512, 3, trainable)
            self.parameters += [kernel5_2, bias5_2]
            
            conv5_3, kernel5_3, bias5_3  = conv_layer('conv5_3', conv5_2, 512, 3, trainable)
            ...
            fc1, fc1W, fc1b = fc_layer('fc1', pool5, 4096, trainable)
            self.parameters += [fc1W, fc1b]
            
            fc2, fc2W, fc2b = fc_layer('fc2', fc1, 4096, trainable)
            self.parameters += [fc2W, fc2b]
            
            fc3, fc3W, fc3b = fc_layer('fc3', fc2, num_classes, trainable)
            self.parameters += [fc3W, fc3b]

        return fc3

    def conv_layer(self, name, input_, output_channel, kernel_size = 3, trainable):
        with tf.name_scope(name) as scope:
            kernel = tf.get_variable(scope + "Weights",
                shape = [kernel_size, kernel_size, input_.get_shape()[-1], output_channel],
                dtype = tf.float32,
                stddev = self.stddev,
                wd = self.wd,
                trainable = trainable,
            ...
            output = tf.nn.relu(tf.nn.bias_add(conv, bias), name=scope.name)
